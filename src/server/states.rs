...
#[get("/scanning?<room>&<player>&<port>")]
fn set_state_scanning(room: Option<String>, player: Option<String>, port: Option<u16>) -> Status {
    controller::set_scanning(room, player, port);
    Status::Ok
}
